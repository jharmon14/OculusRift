/************************************************************************************
 *
 * Filename :   CameraFade.cs
 * Content  :   Fade Camera to color after seconds and can load a level
 * Expects  :   Fade in: 
 *                  CameraFade.StartAlphaFade(Color.black, true, 2.0f);
 *              Fade out: 
 *                  CameraFade.StartAlphaFade(Color.black, false, 2.0f, 2.0f, () => { Application.LoadLevel(sb.sceneName); });
  * Authors  :   dannyskim, Unity Wiki, http://wiki.unity3d.com/index.php?title=FadeInOut#Another_Fade_Script_in_C.23.2C_Extended_Singleton
 * 
************************************************************************************/
